...
function Search() {
  ...
  // and keep the change if change through url
  useEffect(() => {
  ...
  const handleChange = (e) => {
    ...
    if (
      ...
      // here we checked value can be "boolean" or can be "string"
      // @ Boolean : come from checkbox
      // @ String: come from the url
      setSidebardata({
        ...sidebardata,
        [e.target.id]:
    ...
    //set the sort and order value according to the id
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // we want to keep the info in url
